...
enum pageflags {
	...
	PG_drop_writeback,	/* drop from pagecache on writeback done */
#ifdef CONFIG_MMU
...
FOLIO_FLAG(drop_writeback, FOLIO_HEAD_PAGE)
	__FOLIO_CLEAR_FLAG(drop_writeback, FOLIO_HEAD_PAGE)
	__FOLIO_SET_FLAG(drop_writeback, FOLIO_HEAD_PAGE)
